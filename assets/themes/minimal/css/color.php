...
.nav-registration li:first-child{
margin-right: 10px;
}
...
.responsive-footer .col-md-6.col-lg-3:first-child {
display: flex;
flex-direction: column;
justify-content: flex-start;
}
.responsive-footer .col-md-6.col-lg-3 {
display: flex;
justify-content: flex-end;
}
.footer-links h5 {
...
#smmnavbar .nav-registration .nav-link, #smmnavbar .nav-registration .nav-link:hover, #smmnavbar .nav-registration .active.nav-link {
...
#footer .responsive-footer .col-lg-3:nth-child(2) {
justify-content: center;
margin-bottom: 30px;
}
#footer .responsive-footer .col-lg-3:nth-child(3) {
justify-content: flex-start;
margin-top: 10px;
}
#footer .responsive-footer .col-lg-3:nth-child(4) {
justify-content: center;
}
/*------ ABOUT PAGE ------*/
.aboutus-page::before {
...
.how-it-works .content-wrapper:last-child{
margin-bottom: 0;
}
/*------ TESTIMONIAL ------*/
#testimonial {
...
#footer .footer-brand, #footer .footer-social, #footer .footer-links {
...
.user-service-list .card-body.table td, .user-service-list .card-body .table th {
padding: 12px 30px;
vertical-align: top;
border-top: none;
font-size: 16px;
...
.user-service-list .card-body .table th:last-child{
text-align: right !important;
}
.user-service-list .table td:last-child{
text-align: right !important;
}
...
.user-service-list .social-media {
...
#login-signup .input-group-merge{
position: relative;
overflow: hidden;
border-bottom: 1px solid #204dcc;
padding-bottom: 10px;
...
#login-signup .input-group-merge .input-group-append, .input-group-merge .input-group-prepend{
position: absolute;
top: 1px;
bottom: 10px;
z-index: 6;
...
#login-signup .input-group-merge .input-group-append, .input-group-merge .input-group-prepend i{
...
color: #232323;
background-image: url(../../../../assets/global/img/down-arrow.png);
background-repeat: no-repeat;
...
.user-service-list .table td, .user-service-list .table th {
padding: 12px 15px;
}
.table {
width: 1015px;
...
@media only screen and (max-width: 767px){
    ...
    .login-info-wrapper, .contact-info-wrapper {
        min-height: 292px;
        padding: 60px 40px;
    }
