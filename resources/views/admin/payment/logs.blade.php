                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form id="filter_form">
                                        ...
                                        <span class="text-cap text-body">@lang('Select panel')</span>
                                        <div class="tom-select-custom mb-4">
                                            <select class="js-select form-select" id="select_panel" autocomplete="off"
                                                    data-hs-tom-select-options='{
                                                      "placeholder": "Select a panel",
                                                      "hideSearch": true
                                                    }'>
                                                <option value="">@lang("Select a panel")</option>
                                                <option value="main_panel">@lang("Main Panel")</option>
                                                <option value="child_panel">@lang("Child Panel")</option>
                                            </select>
                                        </div>
                                            ...
                                            <div class="col-12 mb-4">
                                                ...
                                                <div class="tom-select-custom">
                                                    <select class="js-select form-select" id="filter_method">
                                                        <option value="all"
                                                                data-option-template='<span class="d-flex align-items-center"><img class="avatar avatar-xss avatar-circle me-2" src="{{ asset("assets/admin/img/payment.png")  }}" alt="..." /><span class="text-truncate">@lang("All Gateway")</span></span>'
    ...
    <script>
        $(document).on('ready', function () {
            ...
            document.getElementById("filter_button").addEventListener("click", function () {
                ...
                let filterPanel = $('#select_panel').val();
                ...
                datatable.ajax.url("{{ route('admin.payment.search') }}" + "?filterTransactionID=" + filterTransactionId + "&filterStatus=" + filterStatus + "&filterMethod=" + filterMethod +
                    "&filterPanel=" + filterPanel + "&filterDate=" + filterDate).load();
            });
