...
@section('page_title', __('Edit Social Media'))
@section('content')
                ...
                <div class="col-sm mb-2 mb-sm-0">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb breadcrumb-no-gutter">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">@lang('Edit Social Media')</li>
                        </ol>
                    </nav>
                    <h1 class="page-header-title">@lang('Edit Social Media')</h1>
                </div>
            </div>
        </div>
                ...
                <div class="d-grid gap-3 gap-lg-5">
                    <div class="card pb-3">
                        <div class="card-header d-flex justify-content-between">
                            <h4 class="card-title m-0">@lang('Edit Social Media')</h4>
                        </div>
                        <div class="card-body mt-2">
                            <form action="{{ route('admin.social-media.update', $social_media->id) }}" method="post"
                                ...
                                <div class="row mb-4 d-flex align-items-center">
                                    ...
                                    <div class="col-md-6">
                                        <label class="row form-check form-switch mt-3" for="socialMediaStatus">
                                            ...
                                            <span class="col-2 col-sm-3 text-end">
                                                 <input type='hidden' value='0' name='status'>
                                                    <input
                                                        ...
                                                        type="checkbox" name="status" id="socialMediaStatus"
                                                        value="1" {{ $social_media->status == 1 ? 'checked' : '' }}>
                                                    <label class="form-check-label text-center"
                                                           for="socialMediaStatus"></label>
                                                </span>
                                            @error('status')
                                    ...
                                    <div class="col-md-3 mb-3 mb-md-0">
                                        ...
                                        <label class="form-check form-check-dashed" for="iconUploader-1">
                                            <img id="img"
                                                 ...
                                                 src="{{ getFile($social_media->icon_driver, $social_media->icon, true) }}"
                                                 alt="@lang("Icon")"
