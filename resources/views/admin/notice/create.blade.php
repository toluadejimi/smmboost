                ...
                <div class="col-sm">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb breadcrumb-no-gutter">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">@lang("Create Notice")</li>
                        </ol>
                    </nav>
                    <h1 class="page-header-title">@lang("Create Notice")</h1>
                </div>
            </div>
        </div>
        ...
        <div class="alert alert-soft-dark mb-5" role="alert">
            <div class="d-flex align-items-center">
                ...
                <div class="flex-grow-1 ms-3">
                    <div class="d-flex align-items-center">
                        <p class="mb-0">@lang("You are creating notice for `$defaultLanguage->name` version.")</p>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="d-grid gap-3 gap-lg-5">
                        <div class="card">
                            <div class="card-header">
                                <h2 class="card-title h4">@lang("Create Notice")</h2>
                            </div>
                            <div class="card-body">
