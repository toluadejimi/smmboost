        ...
        <div class="shadow p-3 mb-5 alert alert-soft-dark mb-4 mb-lg-7" role="alert">
            <div class="alert-box d-flex flex-wrap align-items-center">
                ...
                <div class="flex-grow-1 ms-3">
                    ...
                    <h3 class="mb-2">You're using `<span>{{snake2Title(basicControl()->theme)}}</span>` theme</h3>
                    ...
                    If you wish to change the <a href="{{route('admin.theme.index')}}">Choose Theme</a> , please navigate to the Themes section to select or customize a new look for your site.
                                ...
                                <table class="table table-thead-bordered table-nowrap table-align-middle card-table">
                                    ...
                                    @forelse($allPages as $page)
                                        <tr>
                                            ...
                                            <td>
                                                @lang(snake2Title($page->template_name))
                                            </td>
