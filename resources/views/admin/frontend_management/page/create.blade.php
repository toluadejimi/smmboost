                ...
                <div class="modal-body">
                    <select id="customBlockSelect" class="js-select form-select">
                        @foreach($sections as $sectionName => $sectionData)
                            <option value="[[{{ $sectionName }}]]" data-section="{{ json_encode($sectionData) }}">{{ ucwords(snake2Title($sectionData['basename'])) }}</option>
                        @endforeach
                    </select>
                </div>
                <div class="modal-footer d-flex justify-content-between">
                    <button id="contentImage1" type="button" class="btn btn-white contentImage1">
                        @lang("View Content")
                    </button>
                    <div>
...
@push('script')
    <script>
        ...
        function initializeContentImageGallery() {
            const contentImageButton = document.getElementById('contentImage1');
            ...
            $('.contentImage1').on('click', function() {
