                                                        ...
                                                        <td>
                                                            <div class="input-group mb-1">
                                                                ...
                                                                <input type="text"
                                                                       ...
                                                                       autocomplete="off">
                                                                <span
                                                                    class="input-group-text">{{ old("receivable_currencies.$i.name", $method->currency_type == 1 && isset($method->receivable_currencies[$i]) ? $method->receivable_currencies[$i]->name  : 'USD') }}</span>
