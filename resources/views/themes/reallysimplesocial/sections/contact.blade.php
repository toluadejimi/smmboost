        ...
        <div class="row">
                ...
                <div class="d-flex align-items-center justify-content-start  wow fadeInLeft" data-wow-duration="1s"
                    ...
                    <div class="wrapper">
                        <div class="contact-info-wrapper">
                            <h5 class="h5 mb-30">@lang(@$contact['single']['title'])</h5>
                            <p class="p mb-30">
                                @lang(@$contact['single']['sub_title'])
                            </p>
                            <div class="media">
                                <img src="{{ asset(template(true).'images/contact/list-img-1.png')}}"
                                     alt="Image Missing">
                                <div class="media-body ml-20">
                                    <h6 class="h6 mb-5">{{trans('Address')}}</h6>
                                    <p class="p">{{@$contact['single']['address']}}</p>
                                </div>
                            </div>
                            <div class="media">
                                <img src="{{asset(template(true).'images/contact/list-img-2.png')}}"
                                     alt="Image Missing">
                                <div class="media-body ml-20">
                                    <h6 class="h6 mb-5">{{trans('Email')}}</h6>
                                    <p class="p">{{@$contact['single']['email']}}</p>
                                </div>
                            </div>
                            <div class="media">
                                <img src="{{asset(template(true).'images/contact/list-img-3.png')}}"
                                     alt="Image Missing">
                                <div class="media-body ml-20">
                                    <h6 class="h6 mb-5">{{trans('Phone')}}</h6>
                                    <p class="p">{{@$contact['single']['phone']}}</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-lg-7">
                <div
                    ...
                    <p class="pheading text-uppercase mb-15">@lang(@$contact['single']['heading'])</p>
                    <h4 class="h4 text-capitalize mb-30">@lang(@$contact['single']['sub_heading'])</h4>
