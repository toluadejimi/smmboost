            ...
            <div class="row g-5">
                <div class="col-lg-6">
                    ...
                    <div class="contact_area">
                        ...
                        <p class="mt-30">{!! __(@$forgotPasswordContent->description->description) !!}</p>
                    </div>
                ...
                <div class="col-lg-6">
                    <div class="login_signup_form p-4">
                        ...
                        <form method="POST" action="{{ route('user.password.email') }}">
                            ...
                            <button type="submit"
                                    class="btn custom_btn mt-30 w-100">@lang('Send Password Reset Link')</button>
                            <div class="pt-20 text-center">
                                @lang("Don't have an account?")
                                <p class="mb-0 highlight"><a href="{{ route('register') }}">@lang('Register here')</a>
                                </p>
                            </div>
                        </form>
                    </div>
