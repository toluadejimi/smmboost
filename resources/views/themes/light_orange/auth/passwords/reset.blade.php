...
@section('title', trans($pageSeo['page_title'] ?? 'Reset Password'))
    ...
    <section class="login-section">
        <div class="container">
            <div class="row g-lg-0 gy-5 align-items-center justify-content-center">
                <div class="col-lg-6 login_signup_form">
                    @if (session('status'))
                    ...
                    <form method="POST" action="{{route('password.update')}}" class="form-content w-100">
                        ...
                        <button type="submit" class="btn custom_btn mt-4">@lang('Reset Password')</button>
                    </form>
                </div>
            </div>
        </div>
