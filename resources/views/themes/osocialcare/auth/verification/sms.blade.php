            ...
            <div class="row">
                ...
                <div class="col-lg-7">
                    <div
                        ...
                        <h4 class="h4 text-uppercase mb-30">@lang($pageSeo['page_title'] ?? 'Verify Phone Number')</h4>
                        ...
                        <form method="POST" action="{{route('user.sms.verify')}}" class="form-content w-100">
                            ...
                            <div class="login">
                                ...
                                <div class="d-flex align-items-center justify-content-between">
                                    <div>
                                        <p>@lang('Didn\'t get Code? Click to') <a href="{{route('user.resend.code')}}?type=mobile"  class="btn-forgetpass text-primary"> @lang('Resend code')</a></p>
                                        @error('resend')
                                        <p class="text-danger  mt-1">{{ trans($message) }}</p>
                                        @enderror
                                        @error('error')
