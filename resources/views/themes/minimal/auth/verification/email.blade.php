            ...
            <div class="row">
                ...
                <div class="col-lg-7">
                    <div
                        ...
                        <h4 class="h4 text-uppercase mb-30">@lang($pageSeo['page_title'] ?? 'Email Verify')</h4>

                        <form method="POST" action="{{route('user.mail.verify')}}" class="form-content w-100">
                            @csrf
                            <div class="login">
                                ...
                                <div class="d-flex align-items-center justify-content-between">
                                    <div>
                                        <p>@lang('Didn\'t get Code? Click to') <a href="{{route('user.resend.code')}}?type=email"  class="btn-forgetpass text-primary"> @lang('Resend code')</a></p>
                                        @error('resend')
