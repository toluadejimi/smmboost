...
@section('title', trans("Email Verify"))
@section('content')
                ...
                <div class="col-lg-6 col-md-10">
                    ...
                    <div class="login-signup-form">
                        <form class="login-form" action="{{route('user.mail.verify')}}" method="post">
                            ...
                            <div>
                                <p class="d-flex flex-wrap">@lang("Your email address is ") <span class="text-warning ms-1"> {!! maskEmail(optional(auth()->user())->email) !!}</span></p>
                            </div>
                            <div class="row g-4">
                                <div class="col-12">
