        ...
        <div class="row gy-4 gy-md-5 gx-sm-5 align-items-center">
            <div class="col-md-6">
                <div class="left-side">
                    ...
                    <p class="cmn-para-text mx-auto mt-20">@lang(strip_tags($faq['single']['short_description']))</p>
                    <div class="btn-area mt-30">
                        <a href="{{ $faq['single']['media']->button_link }}" class="cmn-btn"
                           target="_blank"> @lang($faq['single']['button_name'])</a>
                    </div>
                </div>
            </div>
            <div class="col-md-6">
