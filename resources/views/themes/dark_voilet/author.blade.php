            ...
            <div class="row">
                <div class="col-12">
                    <div class="section-header text-center mb-50">
                        <span class="section-subtitle">@lang(optional($blogContent->description)->title)</span>
                        <h3 class="section-title mx-auto">@lang(optional($blogContent->description)->sub_title)</h3>
                        <p class="cmn-para-text mx-auto mt-20">@lang(optional($blogContent->description)->short_description)</p>
                    </div>
                </div>
            </div>
            <div class="row g-4">
                                ...
                                <ul class="meta">
                                    <li class="item">
                                        <a href="{{ route('blog.author', optional(optional($item->author)->details)->slug) }}"><span
                                            ...
                                            <span>@lang("by") {{ optional(optional($item->author)->details)->name }}</span></a>
                                    </li>
                                    <li class="item">
