                                ...
                                <div class="box-card grayish-blue-card moduleRecord">
                                    ...
                                    <div class="bottom">
                                        <div class="item" data-bs-toggle="tooltip" data-bs-placement="top"
                                            ...
                                            @else
                                                <span
                                                    class="fw-semibold">  {{ currencyPosition($walletBalance) }}</span>
                                            @endif
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="box-card strong-olive-card moduleRecord">
                                    ...
                                    <div class="bottom fw-semibold">
                                        <div class="item" data-bs-toggle="tooltip" data-bs-placement="top"
                                            ...
                                            @if(optional(auth()->user())->currency && $currency)
                                                <span>{{ currencyPositionBySelectedCurrency($totalLast7DaysDeposits * $currency->conversion_rate, auth()->user()->currency) }}</span>
                                            @else
                                                <span>  {{ currencyPosition($totalLast7DaysDeposits) }}</span>
                                            @endif
                                        ...
                                        <div class="item" data-bs-toggle="tooltip" data-bs-placement="top"
                                            ...
                                            <i class="fa-regular fa-money-check-dollar"></i>
                                            @if(optional(auth()->user())->currency && $currency)
                                                <span>{{ currencyPositionBySelectedCurrency($totalYearDeposits * $currency->conversion_rate, auth()->user()->currency) }}</span>
                                            @else
                                                <span>  {{ currencyPosition($totalYearDeposits) }}</span>
                                            @endif
                                        </div>
                                    </div>
                                </div>
