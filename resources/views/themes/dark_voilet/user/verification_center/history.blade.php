...
@section('content')
    <main id="main" class="main bg-color2">
        <div class="pagetitle">
            <h3 class="mb-1">@lang("KYC Verification History")</h3>
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">@lang("KYC Verification History")</li>
                </ol>
            </nav>
        </div>
        ...
        <div class="card">
            <div class="card-header d-flex justify-content-between border-0">
                ...
                <div class="btn-area">
                    <button type="button" class="cmn-btn filter-btn" data-bs-toggle="offcanvas" data-bs-target="#kycFilter"
                ...
                @else
                    <div class="text-center p-4">
                        <img class="error-image mb-3"
                             ...
                             alt="Error Image" data-hs-theme-appearance="default">
