...
<div class="pwa-popup" id="pwaInstallPopup">
    <div class="header">
        <div class="d-flex flex-wrap">
            <img
                src="{{getFile(@$pwa['single']['media']->icon_image->driver, @$pwa['single']['media']->icon_image->path)}}"
                alt="PWA Logo"
                class="pwa-logo">
    ...
    <div class="carousel-container" id="carouselContainer">
        <div class="carousel">
            ...
            <div class="carousel-content" id="carouselContent">
                @if(!empty($pwa['multiple']))
                    @foreach(collect($pwa['multiple'])->toArray() as $item)
                        <img
                            src="{{getFile($item['media']->carousel_image->driver??null,$item['media']->carousel_image->path??null)}}"
                            alt="Carousel Image">
                    @endforeach
                @endif
