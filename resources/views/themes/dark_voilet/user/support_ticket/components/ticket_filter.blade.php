            ...
            <div class="row g-4">
                ...
                <div id="formModal">
                    ...
                    <select class="modal-select" name="status">
                        ...
                        <option value="0" {{ request()->status == 0 ? 'selected' : '' }}>@lang("Open")</option>
                        <option value="1" {{ request()->status == 1 ? 'selected' : '' }}>@lang("Answered")</option>
                        <option value="2" {{ request()->status == 2 ? 'selected' : '' }}>@lang("Replied")</option>
                        <option value="3" {{ request()->status == 3 ? 'selected' : '' }}>@lang("Closed")</option>
                    </select>
                </div>
                <div>
