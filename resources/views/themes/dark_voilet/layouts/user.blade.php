...
@if(env('IS_DEMO') == true)
    <div class="">
        <a class="cmn-btn sticky-btn"
           href="<?php echo url()->current() ?>?user_dashboard={{ session('user_dashboard') == 'user_dashboard_style_one' ? 'user_dashboard_style_two' : 'user_dashboard_style_one' }}"><i
                class="fa-regular fa-rotate"></i> Swap Dashboard</a>
    </div>
@endif

@include(template().'user.partials.header')
