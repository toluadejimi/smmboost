        ...
        <div class="row">
            <div class="col-12">
                <div class="card mb-50">
                    ...
                    <div class="card-body">
                        <small>@lang("Note: Please read the API instructions carefully. Its your solo responsibility what you add by our API.")</small>
                ...
                <div class="card mb-50">
                    ...
                    <div class="card-body">
                        <div class="cmn-table">
                            <div class="table-responsive ">
                                <table class="table table-striped place-new-order-table align-middle">
                                    <thead>
                                    <tr>
                                        <th scope="col">@lang("Parameter")</th>
                                        <th scope="col">@lang("Description")</th>
                                    ...
                                    <tr>
                                        <td data-label="@lang("Parameter")"><span>@lang("runs") <small>(optional)</small></span>
                                        </td>
                                        <td data-label="@lang("Description")">
      ...
      "remains": 0
                ...
                <div class="card mb-50">
                    ...
                    <div class="card-body">
                        <div class="cmn-table">
                            <div class="table-responsive">
                                <table class="table table-striped align-middle place-refill-order">
                                    <thead>
                                    <tr>
                                        <th scope="col">@lang("Parameter")</th>
                                        <th scope="col">@lang("Description")</th>
   ...
   "refill": "1"
                ...
                <div class="card mb-50">
                    ...
                    <div class="card-body">
                        <div class="cmn-table">
                            <div class="table-responsive">
                                <table class="table table-striped align-middle status-refill-table">
                                    <thead>
                                    <tr>
                                        <th scope="col">@lang("Parameter")</th>
                                        <th scope="col">@lang("Description")</th>
                                    ...
                                    <tr>
                                        <td data-label="@lang("Parameter")"><span>@lang("refill")</span></td>
                                        <td data-label="@lang("Description")">
   ...
   "status": "Completed"
                ...
                <div class="card mb-50">
                    ...
                    <div class="card-body">
                        <div class="cmn-table">
                            <div class="table-responsive">
                                <table class="table table-striped align-middle service-table">
                                    <thead>
                                    <tr>
                                        <th scope="col">@lang("Parameter")</th>
                                        <th scope="col">@lang("Description")</th>
